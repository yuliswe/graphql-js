...
function findConflict(context, cachedFieldsAndFragmentNames, comparedFragmentPairs, parentFieldsAreMutuallyExclusive, responseName, field1, field2) {
    ...
    if (selectionSet1 && selectionSet2) {
        const conflicts = findConflictsBetweenSubSelectionSets(context, cachedFieldsAndFragmentNames, comparedFragmentPairs, areMutuallyExclusive, (0, definition_1.getNamedType)(type1), selectionSet1, (0, definition_1.getNamedType)(type2), selectionSet2);
...
function stringifyArguments(fieldNode) {
    ...
    const args = /* c8 ignore next */ (_a = fieldNode.arguments) !== null && _a !== void 0 ? _a : [];
    ...
    return (0, printer_1.print)((0, sortValueNode_1.sortValueNode)(inputObjectWithArgs));
}
...
class PairSet {
    ...
    has(a, b, areMutuallyExclusive) {
        ...
        const result = (_a = this._data.get(key1)) === null || _a === void 0 ? void 0 : _a.get(key2);
        if (result === undefined) {
            return false;
        }
